...
namespace NorthwindData.Models
{
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<VwUrunsipari> VwUrunsiparis { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=DESKTOP-NVISFR6;Initial Catalog=Northwind;User ID=sa;Password=123456;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<VwUrunsipari>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("VW_URUNSIPARIS");

                entity.Property(e => e.ProductName).HasMaxLength(40);

                entity.Property(e => e.Tutar).HasColumnType("decimal(15, 3)");
            });
